...
namespace LLASDecryptor.Core
{
    public static class DatabaseTables
    {
        public static List<Table> Tables { get; } = new List<Table>()
        {
            ...
            new AudioTable("m_asset_sound", "Sound Assets (Voices)", "vo_"),
            new AudioTable("m_asset_sound", "Sound Assets (Music)", "music_"),
            new AudioTable("m_asset_sound", "Sound Assets (Background Music)", "bgm_"),
            new AudioTable("m_asset_sound", "Sound Assets (SFX)", "se_"),
